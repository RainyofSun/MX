...
@interface MXAPPCardFacePopView ()
...
@implementation MXAPPCardFacePopView
...
- (void)setupUI {
    ...
    [self.errorLeftItem setItemTitle:[[MXAPPLanguage language] languageValue:@"pop_card_certification_error4"] andImage:@"certification_face_left_error"];
    [self.errorMidItem setItemTitle:[[MXAPPLanguage language] languageValue:@"pop_card_certification_error5"] andImage:@"certification_face_mid_error"];
    [self.errorRightItem setItemTitle:[[MXAPPLanguage language] languageValue:@"pop_card_certification_error6"] andImage:@"certification_face_right_error"];
...
- (UIImageView *)typeImgView {
    if (!_typeImgView) {
        _typeImgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pop_certification_face"]];
    }
...
- (UILabel *)tipLab {
    if (!_tipLab) {
        ...
        _tipLab.text = [[MXAPPLanguage language] languageValue:@"pop_card_certification_face_tip"];
